  ...
  function defineKonami() {
    ...
    Konami = function (konami, func) {
      ...
      document.addEventListener('keydown', function(e) {
        ...
        if(e.keyCode == codes[konami[count]]){
          count++;
